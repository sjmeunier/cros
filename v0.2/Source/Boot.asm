...
;Serge Meunier
;
;FAT 12 boot sector. Compatible with MSDOS/Windows too
;-----------------------------------------------------
[BITS 16]
[ORG 0x0000]
jmp     START
     ...
     msgLoading  db 0x0D, 0x0A, "Loading CrOS ", 0x0D, 0x0A, 0x00
     msgCRLF     db 0x0D, 0x0A, 0x00
     msgProgress db ".", 0x00
     msgFailure  db 0x0D, 0x0A, "ERROR: Ummm...You gonna reboot. Press Any Key.", 0x00
